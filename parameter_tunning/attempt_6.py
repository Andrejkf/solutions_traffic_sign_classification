...
def LeNet(x):    
    ...
    # TODO: Layer 0: Convolutional. Input = 32x32x3. Output = 32x32x6.
    conv0_w = tf.Variable(tf.truncated_normal((5,5,3,6), mean= mu, stddev= sigma))
    ...
    drop0 = tf.nn.dropout(conv0, 0.9)
        
    # TODO: Layer 1: Convolutional. Input = 32x32x6. Output = 32x32x32.
    conv1_w = tf.Variable(tf.truncated_normal((5,5,6,32), mean= mu, stddev= sigma))
    conv1_b = tf.Variable(tf.zeros(32))
    conv1   = tf.nn.conv2d(drop0, conv1_w, strides=[1,1,1,1], padding='SAME') + conv1_b
    ...
    # TODO: Layer 2: Convolutional. Input = 16x16x32. Output = 16x16x32.
    conv2_w = tf.Variable(tf.truncated_normal((5,5,32,32), mean= mu, stddev= sigma))
    conv2_b = tf.Variable(tf.zeros(32))
    conv2   = tf.nn.conv2d(drop1, conv2_w, strides=[1,1,1,1], padding='SAME') + conv2_b
    ...
    # TODO: Layer 3: Convolutional. Input = 8x8x32. Output = 8x8x32.
    conv3_w = tf.Variable(tf.truncated_normal((5,5,32,32), mean= mu, stddev= sigma))
    conv3_b = tf.Variable(tf.zeros(32))
    conv3   = tf.nn.conv2d(drop2, conv3_w, strides=[1,1,1,1], padding='SAME') + conv3_b
    ...
    # TODO: Flatten. Input = 8x8x32. Output = 2048.(because 8x8x32 = 2048)
