...
def LeNet(x):    
    ...
    # TODO: Layer 1: Convolutional. Input = 32x32x6. Output = 28x28x6.
    conv1_w = tf.Variable(tf.truncated_normal((5,5,6,6), mean= mu, stddev= sigma))
    ...
    # TODO: Pooling. Input = 24x24x6. Output = 14x14x6.
    conv1 = tf.nn.max_pool(conv1, ksize=[1,2,2,1], strides=[1,2,2,1], padding='VALID')

    drop1 = tf.nn.dropout(conv1, 0.5)
