...
def LeNet(x):    
    ...
    conv0_w = tf.Variable(tf.truncated_normal((5,5,3,16), mean= mu, stddev= sigma))
    ...
    conv1_w = tf.Variable(tf.truncated_normal((5,5,16,32), mean= mu, stddev= sigma))
    ...
    # TODO: Flatten. Input = 5x5x64. Output = 1600.(because 5x5x64 = 1600)
