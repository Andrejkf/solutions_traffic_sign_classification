...
Also, dropout layers can help to distribute knowledge thorughout the network. [Read this paper for further information](https://www.cs.toronto.edu/~hinton/absps/JMLRdropout.pdf).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3OTUwMzY5NTddfQ==
-->