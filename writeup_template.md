...
To train the model the initial batch size was 128 but changed to 256 with out any GPU/CPU/RAM memory problems. Initially just the training set was used 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NTI0Njk4MTddfQ==
-->